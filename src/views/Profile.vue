...
<div class="wrapper">
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="https://i.postimg.cc/1zGJ1wCS/download.jpg" alt="profile card">
    </div>

    <div class="profile-card__cnt js-profile-cnt">
      <div class="profile-card__name">{{currentCustomer.name}}</div>
      <div class="profile-card__txt"><strong>customer id:{{currentCustomer.id}}</strong></div>
      <div class="profile-card-loc">
        <span class="profile-card-loc__txt">
          <strong> Phone Number:{{currentCustomer.phone_number}}</strong>
        </span>
      </div>
